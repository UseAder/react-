...
function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } } //createStore是拿来创建一个仓库 1...............
...
var todoReducer = function todoReducer() {
    ...
    var type = action.type,
        payload = action.payload; //type操作的类型 添加、修改、删除
...
var Appfu = function (_React$Component) {
    _inherits(Appfu, _React$Component);

    function Appfu() {
        _classCallCheck(this, Appfu);

        return _possibleConstructorReturn(this, (Appfu.__proto__ || Object.getPrototypeOf(Appfu)).apply(this, arguments));
    }
    ...
    _createClass(Appfu, [{
        ...
        value: function componentWillMount() {
            _axios2.default.get('db.json').then(function (res) {
                // console.log(res);
        ...
        value: function render() {
            ...
            var todos = store.getState().map(function (item, idx) {
                //  8................
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('input', { type: 'text', ref: 'ipt' }),
                _react2.default.createElement('input', { type: 'button', value: '\u6DFB\u52A0todo', onClick: this.saveTODO.bind(this) }),
                _react2.default.createElement(
                    'ul',
                    null,
                    todos
...
var store = (0, _redux.createStore)(todoReducer); //仓库管理创建 3....................
console.log(store);

//store和组件进行衔接 即view视图传入信息   后面还会有个实时监控
function renderIn() {
    // 5.......................
    _reactDom2.default.render(_react2.default.createElement(Appfu, null), document.getElementById('roodt'));
}
renderIn();
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(5);var invariant=__webpack_require__(6);var warning=__webpack_require__(7);var ExecutionEnvironment=__webpack_require__(10);var _assign=__webpack_require__(3);var emptyFunction=__webpack_require__(2);var EventListener=__webpack_require__(11);var getActiveElement=__webpack_require__(12);var shallowEqual=__webpack_require__(13);var containsNode=__webpack_require__(14);var focusNode=__webpack_require__(15);var emptyObject=__webpack_require__(4);var checkPropTypes=__webpack_require__(9);var hyphenateStyleName=__webpack_require__(37);var camelizeStyleName=__webpack_require__(39);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
