...
class Counter extends Component{
    ...
    render(){
        // console.log(this.props);
        const {count,increase,count1,decrease,lists,fetchList,carts,addToCartAt,addToProAt}=this.props;//导出动作三
        // console.log(this.props);
    // console.log(lists);/
            ...
            lists.subjects.map((item,i)=>{
                return lst.push(
                    <li key={i}>
                        ...
                        <NavLink to="/product-intro"><button type="button" className="btn btn-info"  data-id={item.id} idx={i}
                        onClick={(e)=>{this.addPro(e)}}>查看活动商家 </button></NavLink>
