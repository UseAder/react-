...
var store = (0, _redux.createStore)(todoReducer, (0, _redux.applyMiddleware)(_reduxThunk2.default)); //仓库管理创建 3....................


var fetchData = function fetchData(postTitle) {
    return function (dispatch, getState) {
        ...
        fetch('http://api.douban.com/v2/movie/top250').then(function (res) {
            console.log(res);
            return res.json();
        }).then(function (data) {
            console.log(data);
    ...
    _createClass(Appfu, [{
        ...
        value: function render() {
            ...
            if (store.getState().list) {
                ...
                todos = store.getState().list.subjects.map(function (item, idx) {
                    //  8................
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { onClick: this.feachData.bind(this) },
                    '\u8BF7\u6C42ajax'
                ),
                _react2.default.createElement(
                    'ul',
